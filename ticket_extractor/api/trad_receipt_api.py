...
async def extract_trad_receipt(data: ImageRequest):
    """
    Extract information from a traditional receipt using base64-encoded image.
...
async def process_extraction(data: ImageRequest):
    ...
    try:
        ...
        # Process receipt using trad_receipt_extractor
